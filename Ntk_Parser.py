            ...
            if re.match(r'^#', line):  # Comment line
                ...
                if line_syntax:
                    if re.match(r'INPUT', line_syntax.group(1), re.IGNORECASE):
                        ...
                        # If the node name is reset, skip it.
        ...
        if line != "":
            if re.match(r'^#', line):
                ...
                if line_syntax:
                    ...
                    # if left_node == "constant_1":
                    #     Circuit_graph.find_node_by_name(left_node).power_node = 1     # logic 1
                    # elif left_node == "constant_0": 
                    #     Circuit_graph.find_node_by_name(left_node).power_node = 2     # logic 0
                    # else: 
                    #     Circuit_graph.find_node_by_name(left_node).power_node = 0     # not a power node

                    # TODO The following block not working, need to fix.
                    # if left_node == "constant_1":
                    #     Circuit_graph.find_node_by_name(left_node).power_node = Circuit_graph.power_Node_type['LOGIC_1']
                    # if left_node == "constant_0":
                    #     Circuit_graph.find_node_by_name(left_node).power_node = Circuit_graph.power_Node_type['LOGIC_0']  
